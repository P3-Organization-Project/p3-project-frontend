    ...
    return (
       <div className="flex flex-col items-center justify-center justify-start h-screen w-screen bg-white text-black">
        ...
        <div className="flex gap-10 mt-4" >
            ...
            <button onClick={goTo("/catalogue")} className="px-4 py-2 bg-gray-200 rounded w-20 h-10 text-white"> 3</button>
            <button onClick={goTo("/catalogue")} className="px-4 py-2 bg-gray-200 rounded w-20 h-10 text-white"> 4</button>
        </div>
    </div>
    )
}
