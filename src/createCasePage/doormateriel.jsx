    ...
    return(
        <div className="flex flex-col items-center justify-center justify-start h-screen w-screen bg-white text-black">
            ...
            <div className="flex gap-10 mt-4" >
                ...
                <button onClick={goTo("/practical")} className="absolute bottom-4 left-4 px-4 py-2 bg-gray-200 rounded w-40 h-15 text-white">Tilbage</button>
                <button onClick={goTo("/orderoverview")} className="absolute bottom-4 right-4 px-4 py-2 bg-gray-200 rounded w-40 h-15 text-white">Næste</button>
            </div>
        </div>
    )
}
export default Doormateriel